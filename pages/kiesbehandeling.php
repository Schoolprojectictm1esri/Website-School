...
//als beheerder kun je geen afspraak inplannen, dit moet echt als klant.
if(getRole() != 1){
    echo '<div class="error">U kunt alleen als geregistreerde klant een afspraak inplannen.</div>';
}else{
    //Gebruiker is klant.
                ...
                if($_POST['behandeling1'] != ''){
                    ...
                    if($_POST['behandeling2'] != ''){
                       ...
                       if(checkinsertbehandelingen($_GET['tijd'], $_GET['datum'], $_POST)){
                        ...
                        //er is maar 1 behandeling geset.
                        if(checkinsertbehandelingen($_GET['tijd'], $_GET['datum'], $_POST)){
